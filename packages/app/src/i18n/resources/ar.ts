...
export const ar: TranslationResources = {
  ...
  hostTools: {
    ...
    sections: {
      quota: {
        title: "مركز الحصص",
        subtitle: "استخدام المنصة الذي يصدره المضيف",
        badge: "حصة",
      },
      roles: {
        title: "الأدوار والنماذج",
        subtitle: "بدّل النموذج الذي يشغّل الدور",
        badge: "أدوار",
      },
      skills: {
        title: "مدير المهارات",
    ...
    empty: {
      ...
      hint: "لا يعلن هذا المضيف عن أي قدرات لأدوات المضيف.",
    },
    unsupported: {
      quota: {
        title: "مركز الحصص غير متوفر",
        hint: "حدّث المضيف لاستخدام هذا.",
      },
      roles: {
        title: "تبديل الأدوار والنماذج غير متوفر",
        hint: "حدّث المضيف لاستخدام هذا.",
      },
      skills: {
    ...
    errors: {
      file_missing: {
        title: "ملف تصدير الحصة مفقود",
        description: "شغّل أمر التحديث في المضيف لإنشاء التصدير.",
      },
      file_corrupt: {
        title: "تصدير الحصة تالف",
        description: "أصلح الملف أو أعد توليده قبل المتابعة.",
      },
      version_mismatch: {
        title: "إصدار تصدير الحصة غير مدعوم",
        description: "حدّث إضافة تصدير الحصة في المضيف إلى إصدار متوافق.",
      },
      cli_missing: {
        title: "أداة سطر أوامر التحديث مفقودة",
        description: "ثبّت أداة تحديث المضيف لتفعيل التحديث اليدوي.",
      },
      cooldown: {
        title: "التحديث في فترة تهدئة",
        description: "انتظر بضع ثوانٍ قبل المحاولة مجدداً.",
      },
      in_progress: {
        title: "تحديث قيد التنفيذ",
        description: "سيرسل المضيف لقطة جديدة فور انتهائه.",
      },
      config_missing: {
        title: "ملف الإعداد مفقود",
        description: "يتوقع المضيف وجود ملف الإعداد.",
      },
      config_corrupt: {
        title: "ملف الإعداد تالف",
        description: "لم يتم تعديل الملف. أصلحه قبل إعادة المحاولة.",
      },
      no_active_preset: {
        title: "لا توجد مجموعة نشطة",
        description: "اختر مجموعة نشطة في إعدادات المضيف قبل تبديل الأدوار.",
      },
      invalid_model: {
        title: "معرّف النموذج غير صالح",
        description: "يجب أن يكون معرّف النموذج بالشكل provider/model.",
      },
      move_conflict: {
        title: "تعارض في النقل",
        description: "توجد مجلدات مهارة بنفس الاسم في الوجهة.",
      },
      permission_denied: {
        title: "الإذن مرفوض",
        description: "رفض المضيف تطبيق التغيير.",
      },
      unknown: {
        title: "حدث خطأ ما",
        description: "راجع سجلات المضيف للاطلاع على الخطأ الأساسي.",
      },
    },
    quota: {
      title: "تصدير الحصة",
      loading: "جارٍ تحميل الحصص...",
      fetchedAt: "تم الجلب {{time}}",
      refresh: "تحديث",
      refreshing: "جارٍ التحديث...",
      stale: {
        title: "البيانات قديمة",
        description: "آخر تصدير تجاوز 5 دقائق. اسحب للأسفل للتحديث.",
      },
      versionMismatch: {
        title: "إصدار التصدير غير مدعوم",
        description: "تحتاج إضافة التصدير في المضيف إلى تحديث.",
      },
      providerError: "خطأ",
      noEntries: "لا توجد بنود لـ {{provider}} بعد",
      unlimited: "غير محدود",
      progressLabel: "متبقي {{name}} {{value}}",
      resetsAt: "تعيد الضبط في {{time}}",
      empty: {
        title: "لا توجد بيانات حصص بعد",
        hint: "شغّل تحديثاً يدوياً لتعبئة التصدير.",
      },
    },
    roles: {
      title: "الأدوار والنماذج",
      loading: "جارٍ تحميل الأدوار...",
      presetName: "المجموعة: {{name}}",
      noModel: "لا يوجد نموذج محدد",
      variant: "البديل: {{value}}",
      hasVariant: "له بديل",
      rowAccessibility: "دور {{role}}",
      empty: {
        title: "لا توجد أدوار",
        hint: "فعّل مجموعة نشطة في المضيف لرؤية أدوارها.",
      },
      writeFailed: "فشل تحديث نموذج الدور",
      writeSuccess: "تم تحديث الدور",
      dismissSuccess: "إخفاء",
      successHint: {
        title: "يستخدم {{role}} الآن {{model}}",
        description: "الجلسات الجديدة ستطبّق هذا تلقائياً.",
      },
      modelPicker: {
        subtitle: "الحالي: {{current}}",
        searchPlaceholder: "ابحث عن النماذج...",
        loading: "جارٍ تحميل النماذج...",
        errorTitle: "فشل تحميل النماذج",
        noMatches: "لا توجد نماذج مطابقة",
        degraded: {
          title: "قائمة النماذج قديمة",
          description: "تعذّر على المضيف تحديث فهرس النماذج. قد تكون القائمة غير مكتملة.",
        },
      },
      variantPicker: {
        subtitle: "النموذج: {{model}}",
        confirm: "حفظ",
      },
      variants: {
        low: "منخفض",
    ...
    skills: {
      ...
      subtitle: "{{count}} مهارات",
      createGroup: "مجموعة جديدة",
      createGroupAction: "إنشاء",
      newGroup: "اسم المجموعة الجديدة",
      newGroupPlaceholder: "مثلاً: lark-tools",
      rename: "إعادة تسمية",
      renameAction: "حفظ",
      ...
      groupRenameFailed: "فشل إعادة تسمية المجموعة",
      groupDeleted: "تم حذف المجموعة",
      groupDeleteFailed: "فشل حذف المجموعة",
      groupUpdateFailed: "فشل تحديث المجموعات",
      skillMoved: "تم نقل المهارة",
      skillUngrouped: "تمت إزالة المهارة من مجموعتها",
      moveTo: "نقل إلى {{name}}",
      moveToUngrouped: "نقل إلى غير مصنّف",
      toggleSkill: "تبديل {{name}}",
      toggleGroup: "تبديل المجموعة {{name}}",
