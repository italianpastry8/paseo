...
export const ru: TranslationResources = {
  ...
  hostTools: {
    menu: {
      trigger: "Инструменты хоста",
      title: "Инструменты хоста",
      items: {
        quota: "Центр квот",
        roles: "Роли и модели",
    ...
    sections: {
      quota: {
        title: "Центр квот",
        subtitle: "Использование платформ, экспортированное хостом",
        badge: "Квота",
      },
      roles: {
        title: "Роли и модели",
        subtitle: "Переключите модель, которую использует роль",
        badge: "Роли",
      },
      skills: {
        title: "Менеджер навыков",
    ...
    empty: {
      ...
      hint: "Этот хост не объявляет возможностей host-tools.",
    },
    unsupported: {
      quota: {
        title: "Центр квот недоступен",
        hint: "Обновите хост, чтобы использовать это.",
      },
      roles: {
        title: "Переключение ролей и моделей недоступно",
        hint: "Обновите хост, чтобы использовать это.",
      },
      skills: {
    ...
    errors: {
      file_missing: {
        title: "Файл экспорта квот отсутствует",
        description: "Запустите команду обновления хоста, чтобы создать экспорт.",
      },
      file_corrupt: {
        title: "Экспорт квот повреждён",
        description: "Восстановите или сгенерируйте файл заново перед продолжением.",
      },
      version_mismatch: {
        title: "Неподдерживаемая версия экспорта квот",
        description: "Обновите плагин экспорта квот хоста до совместимой версии.",
      },
      cli_missing: {
        title: "CLI обновления отсутствует",
        description: "Установите CLI обновления хоста, чтобы включить ручное обновление.",
      },
      cooldown: {
        title: "Идёт перезарядка обновления",
        description: "Подождите несколько секунд перед повторной попыткой.",
      },
      in_progress: {
        title: "Обновление уже выполняется",
        description: "Хост доставит новый снимок, как только закончит.",
      },
      config_missing: {
        title: "Файл конфигурации отсутствует",
        description: "Хост ожидает наличие файла конфигурации.",
      },
      config_corrupt: {
        title: "Файл конфигурации повреждён",
        description: "Файл не был изменён. Исправьте его перед повторной попыткой.",
      },
      no_active_preset: {
        title: "Нет активного пресета",
        description: "Выберите пресет в настройках хоста перед переключением ролей.",
      },
      invalid_model: {
        title: "Недопустимый id модели",
        description: "Id модели должен иметь вид provider/model.",
      },
      move_conflict: {
        title: "Конфликт при перемещении",
        description: "Папка навыка с таким именем уже существует в месте назначения.",
      },
      permission_denied: {
        title: "Доступ запрещён",
        description: "Хост отказался применить изменение.",
      },
      unknown: {
        title: "Что-то пошло не так",
        description: "Смотрите журналы хоста для подробностей.",
      },
    },
    quota: {
      title: "Экспорт квот",
      loading: "Загрузка квот...",
      fetchedAt: "Получено {{time}}",
      refresh: "Обновить",
      refreshing: "Обновление...",
      stale: {
        title: "Данные устарели",
        description: "Последний экспорт старше 5 минут. Потяните, чтобы обновить.",
      },
      versionMismatch: {
        title: "Неподдерживаемая версия экспорта",
        description: "Плагин экспорта хоста нужно обновить.",
      },
      providerError: "Ошибка",
      noEntries: "У {{provider}} пока нет записей",
      unlimited: "Без лимита",
      progressLabel: "{{name}} осталось {{value}}",
      resetsAt: "Сброс в {{time}}",
      empty: {
        title: "Данных о квотах пока нет",
        hint: "Запустите ручное обновление, чтобы заполнить экспорт.",
      },
    },
    roles: {
      title: "Роли и модели",
      loading: "Загрузка ролей...",
      presetName: "Пресет: {{name}}",
      noModel: "Модель не назначена",
      variant: "Вариант: {{value}}",
      hasVariant: "Вариант",
      rowAccessibility: "Роль {{role}}",
      empty: {
        title: "Роли не найдены",
        hint: "Активируйте пресет на хосте, чтобы увидеть его роли.",
      },
      writeFailed: "Не удалось обновить модель роли",
      writeSuccess: "Роль обновлена",
      dismissSuccess: "Скрыть",
      successHint: {
        title: "{{role}} теперь использует {{model}}",
        description: "Новые сессии применят это автоматически.",
      },
      modelPicker: {
        subtitle: "Текущая: {{current}}",
        searchPlaceholder: "Поиск моделей...",
        loading: "Загрузка моделей...",
        errorTitle: "Не удалось загрузить модели",
        noMatches: "Нет подходящих моделей",
        degraded: {
          title: "Список моделей устарел",
          description: "Хост не смог обновить каталог моделей. Список может быть неполным.",
        },
      },
      variantPicker: {
    ...
    skills: {
      ...
      subtitle: "{{count}} навыков",
      createGroup: "Новая группа",
      createGroupAction: "Создать",
      newGroup: "Название новой группы",
      newGroupPlaceholder: "например: lark-tools",
      rename: "Переименовать",
      ...
      groupUpdateFailed: "Не удалось обновить группы",
      skillMoved: "Навык перемещён",
      skillUngrouped: "Навык убран из группы",
      moveTo: "Переместить в {{name}}",
      moveToUngrouped: "Переместить в без группы",
      toggleSkill: "Переключить {{name}}",
      toggleGroup: "Переключить группу {{name}}",
