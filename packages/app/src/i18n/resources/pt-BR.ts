...
export const ptBR: TranslationResources = {
  ...
  hostTools: {
    menu: {
      trigger: "Ferramentas do host",
      title: "Ferramentas do host",
      items: {
    ...
    sections: {
      quota: {
        title: "Central de cotas",
        subtitle: "Uso das plataformas exportado pelo host",
        badge: "Cota",
      },
      roles: {
        title: "Funções e modelos",
        subtitle: "Alterne o modelo usado pela função",
        badge: "Funções",
      },
      skills: {
    ...
    empty: {
      ...
      hint: "Este host não anuncia nenhuma capacidade host-tools.",
    },
    unsupported: {
      quota: {
        title: "Central de cotas indisponível",
        hint: "Atualize o host para usar isso.",
      },
      roles: {
        title: "Troca de função e modelo indisponível",
        hint: "Atualize o host para usar isso.",
      },
      skills: {
    ...
    errors: {
      file_missing: {
        title: "Arquivo de exportação de cotas ausente",
        description: "Execute o comando de atualização do host para gerar a exportação.",
      },
      file_corrupt: {
        title: "Exportação de cotas corrompida",
        description: "Repare ou gere o arquivo novamente antes de continuar.",
      },
      version_mismatch: {
        title: "Versão de exportação de cotas não suportada",
        description: "Atualize o plugin de exportação de cotas do host para uma versão compatível.",
      },
      cli_missing: {
        title: "CLI de atualização ausente",
        description: "Instale a CLI de atualização do host para habilitar a atualização manual.",
      },
      cooldown: {
        title: "Atualização em cooldown",
        description: "Aguarde alguns segundos antes de tentar novamente.",
      },
      in_progress: {
        title: "Já existe uma atualização em andamento",
        description: "O host entregará um novo snapshot assim que terminar.",
      },
      config_missing: {
        title: "Arquivo de configuração ausente",
        description: "O host espera que o arquivo de configuração esteja presente.",
      },
      config_corrupt: {
        title: "Arquivo de configuração corrompido",
        description: "O arquivo não foi modificado. Repare-o antes de tentar novamente.",
      },
      no_active_preset: {
        title: "Nenhum preset ativo",
        description: "Selecione um preset na configuração do host antes de alternar funções.",
      },
      invalid_model: {
        title: "ID de modelo inválido",
        description: "O ID do modelo deve estar no formato provider/model.",
      },
      move_conflict: {
        title: "Conflito ao mover",
        description: "Já existe uma pasta de skill com o mesmo nome no destino.",
      },
      permission_denied: {
        title: "Permissão negada",
        description: "O host recusou aplicar a alteração.",
      },
      unknown: {
        title: "Algo deu errado",
        description: "Consulte os logs do host para ver o erro subjacente.",
      },
    },
    quota: {
      title: "Exportação de cotas",
      loading: "Carregando cotas...",
      fetchedAt: "Coletado {{time}}",
      refresh: "Atualizar",
      refreshing: "Atualizando...",
      stale: {
        title: "Dados desatualizados",
        description: "A última exportação tem mais de 5 minutos. Puxe para atualizar.",
      },
      versionMismatch: {
        title: "Versão de exportação não suportada",
        description: "O plugin de exportação do host precisa ser atualizado.",
      },
      providerError: "Erro",
      noEntries: "{{provider}} ainda não tem entradas",
      unlimited: "Ilimitado",
      progressLabel: "Restante de {{name}} {{value}}",
      resetsAt: "Redefine às {{time}}",
      empty: {
        title: "Ainda não há dados de cota",
        hint: "Execute uma atualização manual para preencher a exportação.",
      },
    },
    roles: {
      title: "Funções e modelos",
      ...
      noModel: "Nenhum modelo atribuído",
      variant: "Variante: {{value}}",
      hasVariant: "Variante",
      rowAccessibility: "Função {{role}}",
      empty: {
        title: "Nenhuma função encontrada",
        hint: "Ative um preset no host para ver suas funções.",
      },
      writeFailed: "Falha ao atualizar o modelo da função",
      writeSuccess: "Função atualizada",
      dismissSuccess: "Dispensar",
      successHint: {
        title: "{{role}} agora usa {{model}}",
        description: "Novas sessões aplicarão isso automaticamente.",
      },
      modelPicker: {
        subtitle: "Atual: {{current}}",
        searchPlaceholder: "Buscar modelos...",
        loading: "Carregando modelos...",
        errorTitle: "Falha ao carregar modelos",
        noMatches: "Nenhum modelo corresponde à busca",
        degraded: {
          title: "Lista de modelos desatualizada",
          description: "O host não conseguiu atualizar o catálogo. A lista pode estar incompleta.",
        },
      },
      variantPicker: {
    ...
    skills: {
      ...
      createGroupAction: "Criar",
      newGroup: "Nome do novo grupo",
      ...
      groupRenameFailed: "Falha ao renomear o grupo",
      groupDeleted: "Grupo excluído",
      groupDeleteFailed: "Falha ao excluir o grupo",
      groupUpdateFailed: "Falha ao atualizar grupos",
      skillMoved: "Skill movido",
      skillUngrouped: "Skill removido do grupo",
      moveTo: "Mover para {{name}}",
      moveToUngrouped: "Mover para sem grupo",
      toggleSkill: "Alternar {{name}}",
      toggleGroup: "Alternar grupo {{name}}",
      toggleFailed: "Falha ao alternar o skill",
      ungrouped: "Outros",
      empty: {
