...
export const ko: TranslationResources = {
  ...
  hostTools: {
    ...
    sections: {
      quota: {
        title: "할당량 센터",
        subtitle: "호스트가 내보낸 공급자 사용량",
        badge: "할당량",
      },
      roles: {
        title: "역할 및 모델",
        subtitle: "역할이 실행할 모델 전환",
        badge: "역할",
      },
      skills: {
        title: "스킬 관리자",
        subtitle: "호스트의 스킬 활성화, 비활성화 및 그룹화",
        badge: "스킬",
      },
      mcp: {
        title: "MCP 관리자",
        subtitle: "MCP 서버 활성화 및 비활성화",
        badge: "MCP",
      },
    },
    empty: {
      title: "호스트 도구를 사용할 수 없습니다",
      hint: "이 호스트는 호스트 도구 기능을 제공하지 않습니다.",
    },
    unsupported: {
      quota: {
        title: "할당량 센터를 사용할 수 없습니다",
        hint: "사용하려면 호스트를 업데이트하세요.",
      },
      roles: {
        title: "역할 및 모델 전환을 사용할 수 없습니다",
        hint: "사용하려면 호스트를 업데이트하세요.",
      },
      skills: {
        title: "스킬 관리자를 사용할 수 없습니다",
        hint: "사용하려면 호스트를 업데이트하세요.",
      },
      mcp: {
        title: "MCP 관리자를 사용할 수 없습니다",
        hint: "사용하려면 호스트를 업데이트하세요.",
      },
    },
    common: {
    ...
    errors: {
      file_missing: {
        title: "할당량 내보내기 파일이 없습니다",
        description: "내보내기를 생성하려면 호스트의 새로고침 명령을 실행하세요.",
      },
      file_corrupt: {
        title: "할당량 내보내기가 손상되었습니다",
        description: "계속하기 전에 파일을 복구하거나 다시 생성하세요.",
      },
      version_mismatch: {
        title: "지원되지 않는 할당량 내보내기 버전",
        description: "호스트의 할당량 내보내기 플러그인을 호환 버전으로 업데이트하세요.",
      },
      cli_missing: {
        title: "새로고침 CLI가 없습니다",
        description: "수동 새로고침을 사용하려면 호스트의 새로고침 CLI를 설치하세요.",
      },
      cooldown: {
        title: "새로고침 대기 중",
        description: "다시 시도하기 전에 몇 초 기다리세요.",
      },
      in_progress: {
        title: "이미 새로고침이 진행 중입니다",
        description: "완료되면 호스트가 새 스냅샷을 전달합니다.",
      },
      config_missing: {
        title: "구성 파일이 없습니다",
        description: "호스트는 구성 파일이 있어야 합니다.",
      },
      config_corrupt: {
        title: "구성 파일이 손상되었습니다",
        description: "파일은 수정되지 않았습니다. 다시 시도하기 전에 파일을 복구하세요.",
      },
      no_active_preset: {
        title: "활성 프리셋 없음",
        description: "역할을 전환하기 전에 호스트 구성에서 프리셋을 선택하세요.",
      },
      invalid_model: {
        title: "잘못된 모델 ID",
        description: "모델 ID는 provider/model 형식이어야 합니다.",
      },
      move_conflict: {
        title: "이동 충돌",
        description: "같은 이름의 스킬 폴더가 대상 위치에 이미 있습니다.",
      },
      permission_denied: {
        title: "권한 거부",
        description: "호스트가 변경 적용을 거부했습니다.",
      },
      unknown: {
        title: "문제가 발생했습니다",
        description: "근본 원인은 호스트 로그를 확인하세요.",
      },
    },
    quota: {
      title: "할당량 내보내기",
      loading: "할당량 불러오는 중...",
      fetchedAt: "{{time}}에 가져옴",
      refresh: "새로고침",
      refreshing: "새로고침 중...",
      stale: {
        title: "데이터가 오래되었습니다",
        description: "마지막 내보내기가 5분보다 오래되었습니다. 당겨서 새로고침하세요.",
      },
      versionMismatch: {
        title: "지원되지 않는 내보내기 버전",
        description: "호스트의 내보내기 플러그인을 업데이트해야 합니다.",
      },
      providerError: "오류",
      noEntries: "{{provider}}에 아직 항목이 없습니다",
      unlimited: "무제한",
      progressLabel: "{{name}} {{value}} 남음",
      resetsAt: "{{time}}에 초기화",
      empty: {
        title: "아직 할당량 데이터가 없습니다",
        hint: "내보내기를 채우려면 수동 새로고침을 실행하세요.",
      },
    },
    roles: {
      title: "역할 및 모델",
      ...
      variant: "변형: {{value}}",
      hasVariant: "변형",
      rowAccessibility: "역할 {{role}}",
      empty: {
        title: "역할을 찾을 수 없습니다",
        hint: "호스트에서 프리셋을 활성화하면 역할을 볼 수 있습니다.",
      },
      writeFailed: "역할의 모델을 업데이트하지 못했습니다",
      writeSuccess: "역할 업데이트됨",
      dismissSuccess: "닫기",
      successHint: {
        title: "{{role}} 이제 {{model}} 사용",
        description: "새 세션에서 자동으로 적용됩니다.",
      },
      modelPicker: {
        subtitle: "현재: {{current}}",
        searchPlaceholder: "모델 검색...",
        loading: "모델 불러오는 중...",
        errorTitle: "모델을 불러오지 못했습니다",
        noMatches: "검색과 일치하는 모델이 없습니다",
        degraded: {
          title: "모델 목록이 오래되었습니다",
          description:
            "호스트가 모델 카탈로그를 새로고침하지 못했습니다. 목록이 불완전할 수 있습니다.",
        },
      },
      variantPicker: {
        subtitle: "모델: {{model}}",
    ...
    skills: {
      ...
      newGroup: "새 그룹 이름",
      newGroupPlaceholder: "예: lark-tools",
      rename: "이름 바꾸기",
      renameAction: "저장",
      renamePlaceholder: "그룹 이름",
      renameGroup: "그룹 {{name}} 이름 바꾸기",
      deleteGroup: "그룹 {{name}} 삭제",
      groupSubtitle: "{{enabled}}/{{total}} 활성화됨",
      groupSubtitleEmpty: "스킬 0개",
      groupEmpty: "이 그룹에 스킬이 없습니다",
      groupCreated: "그룹 생성됨",
      groupCreateFailed: "그룹을 만들지 못했습니다",
      groupRenamed: "그룹 이름이 변경되었습니다",
      groupRenameFailed: "그룹 이름을 바꾸지 못했습니다",
      groupDeleted: "그룹 삭제됨",
      groupDeleteFailed: "그룹을 삭제하지 못했습니다",
      groupUpdateFailed: "그룹을 업데이트하지 못했습니다",
      skillMoved: "스킬 이동됨",
      skillUngrouped: "스킬이 그룹에서 제거되었습니다",
      moveTo: "{{name}}(으)로 이동",
      moveToUngrouped: "그룹 없음으로 이동",
      toggleSkill: "{{name}} 토글",
      toggleGroup: "그룹 {{name}} 토글",
      toggleFailed: "스킬을 토글하지 못했습니다",
      ungrouped: "기타",
      empty: {
        title: "아직 스킬이 없습니다",
        hint: "호스트가 등록한 스킬이 없습니다.",
      },
    },
    mcp: {
      title: "MCP 관리자",
      ...
      subtitle: "서버 {{count}}개",
      newSessionHint: "토글은 새 세션에서 적용됩니다",
      toggleServer: "{{name}} 토글",
      toggleFailed: "MCP 서버를 토글하지 못했습니다",
      serverMeta: "{{type}} · {{command}}",
      empty: {
        title: "MCP 서버 없음",
        hint: "opencode.jsonc에서 서버를 추가하세요",
      },
    },
  },
};
