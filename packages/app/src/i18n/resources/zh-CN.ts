...
export const zhCN: TranslationResources = {
  ...
  hostTools: {
    ...
    sections: {
      quota: {
        title: "额度中心",
        subtitle: "由 host 导出的平台用量",
        badge: "额度",
      },
      roles: {
        title: "角色模型",
        subtitle: "切换角色运行所用的模型",
        badge: "角色",
      },
      skills: {
        title: "Skill 管理",
    ...
    empty: {
      title: "暂无可用的主机工具",
      hint: "该 host 未声明任何 host-tools 能力。",
    },
    unsupported: {
      quota: {
        title: "额度中心不可用",
    ...
    errors: {
      file_missing: {
        title: "额度导出文件缺失",
        description: "请运行 host 的刷新命令生成导出文件。",
      },
      file_corrupt: {
        title: "额度导出文件已损坏",
        description: "请修复或重新生成文件后继续。",
      },
      version_mismatch: {
        title: "暂不支持的导出版本",
        description: "请升级 host 的额度导出插件到兼容版本。",
      },
      cli_missing: {
        title: "刷新 CLI 缺失",
        description: "请安装 host 的刷新 CLI 后再手动刷新。",
      },
      cooldown: {
        title: "刷新冷却中",
        description: "请稍等几秒再试。",
      ...
      in_progress: {
        title: "已有刷新在执行",
        description: "host 完成后会自动推送新快照。",
      },
      config_missing: {
        title: "配置文件缺失",
        description: "host 期望该配置文件存在。",
      },
      config_corrupt: {
        title: "配置文件已损坏",
        description: "文件未被修改,请先修复后再重试。",
      },
      no_active_preset: {
        title: "未选择激活的 preset",
        description: "请在 host 配置中选中一个 preset 后再切换角色。",
      },
      invalid_model: {
        title: "非法模型 id",
        description: "模型 id 必须形如 provider/model。",
      },
      move_conflict: {
        title: "移动冲突",
        description: "目标位置已存在同名 skill 目录。",
      },
      permission_denied: {
        title: "权限被拒绝",
        description: "host 拒绝了本次写入。",
      },
      unknown: {
        title: "出错了",
        description: "请查看 host 日志获取底层错误。",
      },
    },
    quota: {
      title: "额度导出",
      ...
      stale: {
        title: "数据已过期",
        description: "上次导出已超过 5 分钟,下拉刷新获取最新数据。",
      },
      versionMismatch: {
        title: "暂不支持的导出版本",
        description: "host 的导出插件需要升级。",
      },
      providerError: "出错",
      noEntries: "{{provider}} 暂无条目",
      unlimited: "无限",
      progressLabel: "{{name}} 剩余 {{value}}",
      resetsAt: "{{time}} 重置",
      empty: {
        title: "暂无额度数据",
        hint: "运行一次手动刷新以生成导出。",
    ...
    roles: {
      ...
      variant: "变体: {{value}}",
      hasVariant: "有变体",
      rowAccessibility: "角色 {{role}}",
      empty: {
        title: "没有可用的角色",
        hint: "请在 host 中激活一个 preset 以查看其角色。",
      },
      writeFailed: "更新角色模型失败",
      writeSuccess: "角色已更新",
      dismissSuccess: "收起",
      successHint: {
        title: "{{role}} 现已使用 {{model}}",
        description: "新会话将自动应用此设置。",
      },
      modelPicker: {
        subtitle: "当前: {{current}}",
        searchPlaceholder: "搜索模型...",
        ...
        degraded: {
          title: "模型列表已过期",
          description: "host 无法刷新模型目录,列表可能不完整。",
        },
      },
      variantPicker: {
        subtitle: "模型: {{model}}",
    ...
    skills: {
      title: "Skill 管理",
      loading: "正在加载 skills...",
      subtitle: "共 {{count}} 个 skill",
      createGroup: "新建分组",
      createGroupAction: "创建",
      newGroup: "新分组名称",
      newGroupPlaceholder: "例如: lark-tools",
      rename: "重命名",
      renameAction: "保存",
      ...
      skillMoved: "skill 已移动",
      skillUngrouped: "skill 已移出分组",
      moveTo: "移到 {{name}}",
      moveToUngrouped: "移到未分组",
      toggleSkill: "切换 {{name}}",
      toggleGroup: "切换分组 {{name}}",
      toggleFailed: "切换 skill 失败",
      ungrouped: "其他",
      empty: {
        title: "暂无 skill",
